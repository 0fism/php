...
$query = "INSERT INTO Members (ParentName, ParentAddr, ParentEmail, ParentMobile, ChildName, ChildDOB, UserID) ";
$query = $query .    " VALUES (";
$query = $query .    "'" . $myPName      . "'" . ",";
$query = $query .    "'" . $myPAddr      . "'" . ",";
$query = $query .    "'" . $myPEmail     . "'" . ",";
$query = $query .    "'" . $myPMobile    . "'" . ",";
$query = $query .    "'" . $myPChildName . "'" . ",";
$query = $query .    "'" . $myPChildDOB  . "'" . ",";
$query = $query .    "'" . $myPUserID    . "'"      ;
$query = $query .           " )";


$queryAdmin = "INSERT INTO Members (ParentName, ParentAddr, ParentEmail, ParentMobile, ChildName, ChildDOB, UserID) ";
$queryAdmin = $queryAdmin .    " VALUES (";
$queryAdmin = $queryAdmin .    "'" . $myPName      . "'" . ",";
$queryAdmin = $queryAdmin .    "'" . $myPAddr      . "'" . ",";
$queryAdmin = $queryAdmin .    "'" . $myPEmail     . "'" . ",";
$queryAdmin = $queryAdmin .    "'" . $myPMobile    . "'" . ",";
$queryAdmin = $queryAdmin .    "'" . $myPChildName . "'" . ",";
$queryAdmin = $queryAdmin .    "'" . $myPChildDOB  . "'" . ",";
$queryAdmin = $queryAdmin .    "'" . $myPChildUID  . "'"      ;
